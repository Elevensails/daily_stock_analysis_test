...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    # ===== U16 配置模块化：新增字段登记（env 名）=====
    "REPAIR_MODEL": {
        "title": "Repair 回退模型",
        "description": "U3 事后校验 repair loop 使用的模型；留空则回退到主模型 default_litellm_model。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 210,
        "help_key": "settings.u16.REPAIR_MODEL",
        "examples": [
            "REPAIR_MODEL=deepseek/deepseek-v4-flash",
        ],
        "docs": _DOC_LLM_CONFIG,
        "warning_codes": [],
    },
    "REPAIR_TEMPERATURE": {
        "title": "Repair 采样温度",
        "description": "U3 repair loop 采样温度，范围 0.0 ~ 2.0。",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0.0, "max": 2.0},
        "display_order": 211,
        "help_key": "settings.u16.REPAIR_TEMPERATURE",
        "examples": [
    ...
    "LANGCHAIN_MODEL_NAME": {
        "title": "Langchain 模型名",
        "description": "run_vibe.py 写 agent/.env 时使用的 langchain 模型名。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 212,
        "help_key": "settings.u16.LANGCHAIN_MODEL_NAME",
        "examples": [
    ...
    "DEEPSEEK_BASE_URL": {
        "title": "DeepSeek 接口地址",
        "description": "DeepSeek OpenAI 兼容接口基础地址（公开 URL，非敏感）。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 213,
        "help_key": "settings.u16.DEEPSEEK_BASE_URL",
        "examples": [
    ...
    "MAX_TOKENS": {
        "title": "生成 Max Tokens",
        "description": "文本生成默认 max_tokens 上限。",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 1},
        "display_order": 214,
        "help_key": "settings.u16.MAX_TOKENS",
        "examples": [
            "MAX_TOKENS=2048",
        ],
        "docs": _DOC_LLM_CONFIG,
    ...
    "MAX_OUTPUT_TOKENS": {
        "title": "生成 Max Output Tokens",
        "description": "文本生成默认 max_output_tokens 上限。",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 1},
        "display_order": 215,
        "help_key": "settings.u16.MAX_OUTPUT_TOKENS",
        "examples": [
    ...
    "REPAIR_MAX_ROUNDS": {
        "title": "Repair 最大轮数",
        "description": "U3 repair loop 最大轮数，硬上限 3（超出会被 clamp）。",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0, "max": 3},
        "display_order": 510,
        "help_key": "settings.u16.REPAIR_MAX_ROUNDS",
        "examples": [
            "REPAIR_MAX_ROUNDS=1",
        ],
        "docs": _DOC_FULL_GUIDE_ENV,
        "warning_codes": [],
    },
    "JUDGE_ENABLED": {
        "title": "事后校验开关",
        "description": "U3 事后校验 gate 总开关；关闭则跳过校验直接发布。",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 511,
        "help_key": "settings.u16.JUDGE_ENABLED",
        "examples": [
            "JUDGE_ENABLED=1",
            "JUDGE_ENABLED=0",
        ],
    ...
    "JUDGE_USE_LLM": {
        "title": "是否启用真实 LLM judge",
        "description": "为 1 时 repair loop 注入真实 LLM judge（默认仅做规则校验）。",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 512,
        "help_key": "settings.u16.JUDGE_USE_LLM",
        "examples": [
            "JUDGE_USE_LLM=0",
            "JUDGE_USE_LLM=1",
        ],
    ...
    "TIME_SLOT": {
        "title": "默认时段",
        "description": "默认分析时段，4 位 HHMM（如 '1800' 表示 18:00）。",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 513,
        "help_key": "settings.u16.TIME_SLOT",
        "examples": [
            "TIME_SLOT=1800",
        ],
        "docs": _DOC_FULL_GUIDE_ENV,
    ...
    "REPORTS_DIR": {
        ...
        "validation": {},
        "display_order": 514,
        "help_key": "settings.u16.REPORTS_DIR",
        "examples": [
            "REPORTS_DIR=reports",
        ],
        "docs": _DOC_FULL_GUIDE_ENV,
    ...
    "DIST_DIR": {
        "title": "前端构建产物目录",
        "description": "Vite 构建产物目录（deploy_pages.py 仅推送此目录）。",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 515,
        "help_key": "settings.u16.DIST_DIR",
        "examples": [
            "DIST_DIR=web/dist",
        ],
        "docs": _DOC_FULL_GUIDE_ENV,
    ...
    "CONFIG_PROFILE": {
        "title": "激活的 Profile",
        "description": "P2 预留：指定激活的 config.yaml[profiles] 节点名（U16 仅解析不切换）。",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 516,
        "help_key": "settings.u16.CONFIG_PROFILE",
        "examples": [
            "CONFIG_PROFILE=",
        ],
        "docs": _DOC_FULL_GUIDE_ENV,
